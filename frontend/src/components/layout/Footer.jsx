        ...
        <div className={styles.footerContent}>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.contact}>
              <p>Plot No. 7, Sector 24, Near Purkhoti Muktangan</p>
              <p>Atal Nagar – 493661, Chhattisgarh</p>
              <p>Phone: (0771) 2474182</p>
              <p>Email: <a href="mailto:iiitnr@iiitnr.ac.in">iiitnr@iiitnr.ac.in</a></p>
            </div>
          </div>
          ...
          <div className={styles.section}>
            ...
            <ul className={styles.linkList}>
              ...
              <li><Link to="/news">News & Achievements</Link></li>
              <li><Link to="/events">Events</Link></li>
              <li><a href="https://www.iiitnr.ac.in" target="_blank" rel="noopener noreferrer">Institute Website</a></li>
            </ul>
          </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.socialLinks}>
              ...
              <a 
                href="https://www.linkedin.com/school/13267953" 
                target="_blank" 
                rel="noopener noreferrer"
                className={styles.socialLink}
                aria-label="LinkedIn"
