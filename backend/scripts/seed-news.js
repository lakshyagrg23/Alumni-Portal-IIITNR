...
async function seedNewsData() {
  try {
    ...
    const newsArticles = [
      {
        title:
          "IIIT Naya Raipur Alumni Secures $2M Series A Funding for Tech Startup",
        content: `
        ...
        `,
        excerpt:
          "IIIT NR alumnus Rahul Sharma raises $2M Series A funding for his AI healthcare startup, showcasing the entrepreneurial spirit of our graduates.",
        featured_image_url:
      ...
      {
        title:
          "IIIT NR Launches New Industry Partnership Program with Leading Tech Companies",
        content: `
        ...
        `,
        excerpt:
          "IIIT NR partners with Microsoft, Google, Amazon, and Flipkart to launch comprehensive Industry Partnership Program for enhanced student opportunities.",
        featured_image_url:
      ...
      },
      {
        ...
        `,
        excerpt:
          "Meet Priya Patel, IIIT NR alumna leading groundbreaking AI research at Microsoft and inspiring the next generation of researchers.",
        featured_image_url:
      ...
      {
        title:
          "Record Placement Season: 95% Students Placed with Average Package of 12 LPA",
        content: `
        ...
        `,
        excerpt:
          "IIIT NR achieves record 95% placement rate with average package of 12 LPA, showcasing excellent industry demand for our graduates.",
        featured_image_url:
      ...
      {
        title:
          "Research Paper by IIIT NR Team Accepted at International Conference",
        content: `
        ...
        `,
        excerpt:
          "IIIT NR research team's breakthrough paper on autonomous vehicle object detection accepted at prestigious ICCV 2024 conference.",
        featured_image_url:
          "https://images.unsplash.com/photo-1581093458791-9f3c3250e8fc?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        author_id: userIds[1],
        category: "research",
        tags: [
          "research",
      ...
      {
        title:
          "Annual Alumni Meet 2024: Reconnecting Generations of Innovation",
        content: `
        ...
        `,
        excerpt:
          "Over 200 alumni gathered for the Annual Alumni Meet 2024, celebrating achievements and launching new scholarship initiatives.",
        featured_image_url:
      ...
      },
      {
        ...
        `,
        excerpt:
          "IIIT NR inaugurates advanced research labs for AI, cybersecurity, and quantum computing, boosting research capabilities significantly.",
        featured_image_url:
      ...
      {
        title:
          "Student Team Wins National Hackathon with Healthcare Innovation",
        content: `
        ...
        `,
        excerpt:
          "IIIT NR students win National Healthcare Hackathon with innovative telemedicine solution, earning ₹2 lakh prize and recognition.",
        featured_image_url:
