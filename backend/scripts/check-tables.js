...
async function checkTables() {
  try {
    ...
    `);
    console.log(
      "\nalumni_contributions columns:",
      contrib.rows.map((r) => r.column_name).join(", "),
    );
    ...
    `);
    console.log(
      "\nalumni_achievements columns:",
      achiev.rows.map((r) => r.column_name).join(", "),
    );
    ...
    console.log(
      ...
      placement.rows.map((r) => r.column_name).join(", "),
    );
