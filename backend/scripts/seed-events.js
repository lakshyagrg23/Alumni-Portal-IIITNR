    ...
    const upcomingEvents = [
      {
        ...
        `,
        requirements:
          "Laptop with Node.js installed, Basic React knowledge, GitHub account",
        benefits:
          "Certificate of completion, Project templates, Career guidance, Networking opportunities",
      ...
      },
      {
        ...
        benefits:
          "Career insights, Networking opportunities, Recording access, Resource links",
      ...
      },
      {
        ...
        `,
        requirements:
          "Minimum 2 years industry experience, Good communication skills, Commitment to 6-month program",
        benefits:
          "Certificate of appreciation, LinkedIn recognition, Networking with faculty, Impact on student lives",
      ...
      },
      {
        ...
        `,
        requirements:
          "Valid ID for hotel entry, Business cards for networking (optional)",
        benefits:
          "Networking opportunities, Industry insights, Recognition, Free dinner, Group photos",
    ...
    const pastEvents = [
      {
        ...
        end_datetime: new Date(
          Date.now() - 30 * 24 * 60 * 60 * 1000 + 6 * 60 * 60 * 1000,
        ), // 6 hours later
      ...
      },
      {
        ...
        end_datetime: new Date(
          Date.now() - 60 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000,
        ), // 4 hours later
        ...
        benefits:
          "Community service certificate, Team building, Environmental impact",
